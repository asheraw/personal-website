...
Source: https://github.com/VoltAgent/awesome-claude-design (MIT). Files served from getdesign.md — download the linked `DESIGN.md`, do not scrape or clone the branded site itself.

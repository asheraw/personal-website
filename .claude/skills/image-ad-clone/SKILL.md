...
2. **[shared/skills/image-ad-clone/prompting/guide.md](shared/prompting/guide.md)** — the full model-agnostic 10-phase workflow (visual analysis → draft prompt → generate-with-reference → iterate → generalize → test → cross-model validate → document → save).
3. **[shared/skills/image-ad-prompting/prompting/template-format.md](../image-ad-prompting/prompting/template-format.md)** — entry skeleton.
4. **[shared/skills/image-ad-prompting/prompting/prompt-library.md](../image-ad-prompting/prompting/prompt-library.md)** — destination for the new entry. 37 validated templates already there; new entries go at T40+.
...
When the [shared guide](shared/prompting/guide.md) Phase 1 tells you to locate the companion generator, look here in order based on the model choice:
...
- **[shared/skills/image-ad-clone/prompting/guide.md](shared/prompting/guide.md)** — full 10-phase workflow
- **[shared/skills/image-ad-prompting/OVERVIEW.md](../image-ad-prompting/OVERVIEW.md)** — ecosystem context
